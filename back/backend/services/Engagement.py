...
def _persist_engagement(platform: str, state: "PipelineState", result: EngagementAnalysis) -> None:
    """Write engagement result to Supabase for future strategy lookups (optional)."""
    try:
        ...
        logger.info("Engagement log persisted to Supabase")
    except Exception as exc:
        logger.debug("Supabase persist skipped (optional): %s", exc)
